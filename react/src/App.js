...
import { Collapse, NavItem, NavbarToggler, NavbarBrand, Dropbox, DropboxItem, DropdownToggle, DropdownMenu, NavLink, UncontrolledDropdown } from 'reactstrap';
import "./App.css";
    ...
    return (
      ...
      <Navbar bg="dark" variant="dark">
        ...
        <Nav className="mr-auto">
          ...
          <Nav.Link> <Link to="/clients/new">New Client </Link> </Nav.Link>
        </Nav>
        <Form inline>
